...
The file [`misc-math-001-10.html`](./misc-math-001-10.html) (see the H5P rendered [here](https://justineuro.github.io/h5p-misc-math-001/misc-math-001-10.html)) contains a simple H5P that uses the [Question Set H5P template](https://h5p.org/question-set) to generate a set of 15 multiple-choice questions in math (from a pool of 30 questions).  
